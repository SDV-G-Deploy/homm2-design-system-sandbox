...
**V2 asset production kit** defines how to create non-HTML visual elements for the system: threshold assets, textures, badges, seals, water-lens instruments, transparent object cutouts, compact sprite sheets, frame corner bitmaps, bitmap hero details, naming, formats, optimization, and visual QA.
...
Latest asset production pass: `assets/v2/frame-corner-solar-brass.svg` and `assets/v2/frame-corner-solar-brass.webp` are applied in `sites/build-brief-desk/` as the first compact frame corner bitmap.

V2 now treats visual generation as a parallel lane to component promotion. Components move repeated HTML/CSS into `css/v2.components.css`; generated visual elements move through named Images 2.0 slots such as seals, badges, textures, instruments, transparent cutouts, compact sprites, frame corners, and bounded hero details.
