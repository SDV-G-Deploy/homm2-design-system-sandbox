...
const TARGETS = [
  ...
  ["V2 visual slot gallery smoke", "/v2/assets.html", "v2"],
  ["V2 primitive board smoke", "/v2/reference.html", "v2"],
  ["V2 promoted helper inventory smoke", "/v2/components.html", "v2"],
  ...
  ["V2 civic route map template smoke", "/starters/v2-site-starter/templates/civic-route-map/index.html", "v2"],
  ...
  ["Sunwell Route Map smoke", "/sites/sunwell-route-map/index.html", "v2"],
];
...
function staticSanity(failures) {
  const htmlFiles = [
    ...
    "starters/v2-site-starter/templates/civic-route-map/index.html",
    ...
    "sites/sunwell-route-map/index.html",
...
function pageCheckExpression(check) {
  return "(() => {" +
    ...
    "if(check==='v2'){common.primaryTop=box('[data-v2-primary]')?.top??null;common.navHeight=box('.v2-topbar')?.height??0;common.v2LabelsReadable=[...document.querySelectorAll('.v2-proofbar span,.v2-nav a')].filter((node)=>node.offsetParent!==null).every((node)=>node.getClientRects().length===1&&node.scrollWidth<=node.clientWidth+1);}" +
    "return common;" +
  "})()";
}
